...
void snowfalke(int x1, int y1, int x5, int y5, int it)
{
    if (it)
    {
        ...
        snowfalke(x[0].first, x[0].second, x[1].first, x[1].second, it - 1);
        snowfalke(x[1].first, x[1].second, x[2].first, x[2].second, it - 1);
        snowfalke(x[2].first, x[2].second, x[3].first, x[3].second, it - 1);
        snowfalke(x[3].first, x[3].second, x[4].first, x[4].second, it - 1);
